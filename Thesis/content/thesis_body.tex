...
\begin{figure}
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            symbolic x coords={Testcase1, Testcase2, Testcase3, Testcase4, Testcase5},
            xtick=data,
            nodes near coords,
            nodes near coords align={vertical},
            ]
        \addplot coordinates {(Testcase1,23) (Testcase2,24) (Testcase3,43) (Testcase4, 46) (Testcase5, 21)};
        \addplot coordinates {(Testcase1,200) (Testcase2,210) (Testcase3,256) (Testcase4, 409) (Testcase5, 158)};
        \legend{dfc,JSON}
        \end{axis}
    \end{tikzpicture}
