...
The following examples are in some cases formated differently from the way they were during my Tests, leading to slightly differing line numbers. They were reformatted for better readability in the Printed version. Original files can be found on my GitHub.\footnote{\url{https://github.com/arne-z/BachelorThesis/tree/master/dsl_code}}
